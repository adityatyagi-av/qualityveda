...
<div className="my-20 max-w-screen-xl mx-auto px-6 md:px-12">
    ...
    <div className="relative lg:flex lg:items-center lg:gap-12">
        <div className="text-center lg:text-left md:mt-12 lg:mt-0 sm:w-10/12 md:w-2/3 sm:mx-auto lg:mr-auto lg:w-6/12">
            <h1 className="text-gray-900 font-bold text-4xl md:text-6xl lg:text-5xl xl:text-6xl dark:text-white">The best way to upgrade
...
<path d="M 21 3 C 11.621094 3 4 10.621094 4 20 C 4 29.378906 11.621094 37 21 37 C 24.710938 37 28.140625 35.804688 30.9375 33.78125 L 44.09375 46.90625 L 46.90625 44.09375 L 33.90625 31.0625 C 36.460938 28.085938 38 24.222656 38 20 C 38 10.621094 30.378906 3 21 3 Z M 21 5 C 29.296875 5 36 11.703125 36 20 C 36 28.296875 29.296875 35 21 35 C 12.703125 35 6 28.296875 6 20 C 6 11.703125 12.703125 5 21 5 Z"></path>
                        ...
                        <input type="search"
                  value={search}
                  onChange={(e) => setSearch(e.target.value)} placeholder="Search Course" className="w-full p-4 rounded-full placeholder-gray-600 dark:placeholder-white bg-transparent" />
            ...
            <div className="mt-12 flex gap-6 lg:gap-12 justify-between grayscale dark:grayscale-0">
                <img src="/assests/avatar.png" className="h-8 sm:h-10 w-auto lg:h-12" alt="" />
                <img src="/assests/avatar.png" className="h-8 sm:h-10 w-auto lg:h-12" alt="" />
                <img src="/assests/avatar.png" className="h-8 sm:h-10 w-auto lg:h-12" alt="" />
                <img src="/assests/avatar.png" className="h-8 sm:h-10 w-auto lg:h-12" alt="" />
