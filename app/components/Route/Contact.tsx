...
const Contact = (props: Props) => {
  return (
    <section className="bg-white dark:bg-hsl-custom">
    <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 text-blue-500 dark:text-blue-400">website.diagruk@gmail.com</p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 text-blue-500 dark:text-blue-400">Ghaziabad , Uttar Pradesh India</p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 text-blue-500 dark:text-blue-400">+91 0000000000</p>
            </div>
        </div>
    </div>
</section>
