      ...
      <form onSubmit={handleSubmit} className={`${styles.label}`}>
        ...
        <div className="mb-5">
          ...
          <textarea
            ...
            cols={30}
            rows={8}
            placeholder="Write description of the course"
        ...
        <div className="w-full flex justify-between">
          ...
          <div className="w-[45%]">
            ...
            <input
              ...
              onChange={(e: any) =>
                setCourseInfo({ ...courseInfo, link: e.target.value })
              }
              id="tags"
              placeholder="https://chat.whatsapp.com/JLAOu9TTvDA6Pm2zLOJY0i"
              className={`
            ${styles.input}`}
            />
          </div>
