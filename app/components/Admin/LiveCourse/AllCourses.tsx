...
} from "@/redux/features/livecourses/livecoursesApi";
...
const AllCourses = (props: Props) => {
  ...
  const { isLoading, data, refetch } = useGetAllLiveCoursesQuery(
    {},
    { refetchOnMountOrArgChange: true }
  );
  const [deleteCourse, { isSuccess, error }] = useDeleteLiveCourseMutation({});
  const columns = [
    ...
    { field: "created_at", headerName: "Created At", flex: 0.5 },
    {
      ...
      renderCell: (params: any) => {
        return (
          <>
            <Link href={`/admin/edit-live-course/${params.row.id}`}>
