...
} from "@/redux/features/nabl/nablApi";
...
const AllCourses: FC<Props> = ({ isTeam }) => {
  ...
  const { isLoading, data, refetch } = useGetAllNABLQuery(
    {},
...
// console.log(data)
  ...
  const columns = [
    ...
    { field: "message", headerName: "Message", flex: 1.0 },
    { field: "created_at", headerName: "Recieved At", flex: 0.2 },
    {
      field: " ",
      headerName: "Delete",
      flex: 0.2,
