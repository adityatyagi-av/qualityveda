...
import {
  ...
  useGetAllTeamsQuery, 
} from "@/redux/features/teams/teamApi";
...
const AllTeams = (props: Props) => {
  ...
  const { isLoading, data, refetch } = useGetAllTeamsQuery(
    {},
    { refetchOnMountOrArgChange: true }
  );
  const [deleteTeam, { isSuccess, error }] = useDeleteTeamMutation({});
  const columns = [
    ...
    { field: "created_at", headerName: "Created At", flex: 0.5 },
    {
      ...
      renderCell: (params: any) => {
        return (
          <>
            <Link href={`/admin/edit-team/${params.row.id}`}>
