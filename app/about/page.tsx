  ...
  return (
    <div className="dark:bg-hsl-custom">
      <Heading
        ...
        description=": Quality Veda, a known medical education, Training and Consultancy service provider can help you enhance t quality of your labs and hospitals. Get Quality control training and Consultancy."
